...
REVISIONS = {
    "invalidation-fix": {
        "before": "4d15fa32764e26df58b16930d0e2503a90880002",
        "after": "66998225a2d0d78e40390c179681b6a48b5e5635",
    },
    "overall": {
...
def main():
    ...
    parser.add_argument("--comparison", choices=REVISIONS, default="invalidation-fix")
